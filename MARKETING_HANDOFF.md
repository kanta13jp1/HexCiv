...
2026-08-05 Stage 4F検証済み配布物:

| 版 | サイズ | SHA256 |
|---|---:|---|
| 製品版 | 37,587,137 bytes | `266364afab666214624b1d84042b87926558bdce5a1b41cc19fe45009fcabf53` |
| 30ターンDemo | 37,589,834 bytes | `c08c29436153d934e1bc40a8b4ac93a777db28affe28ea953dfd20dd7701181e` |
...
760×446で再生成できる。2026-08-05生成版は69,807 bytes、SHA256
`d4854788de2c4cc041614b3e40ab1933902bc1cdab806f6c5b79403e8910fb7f`。商品ページへ載せる際は、
圧縮前のPNGを使い、実ゲーム画面であることと上下流関係が `inferred` な復元であることを明記する。
...
Stage 4Fは開始前に完成した更新候補であり、まだH10第1週として公開・計測していない。
