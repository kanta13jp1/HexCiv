...
| Historical campaign | `Core/HistoricalCampaign.cs, Core/HistoricalContentSchema.cs, Core/HistoricalCampaignFactory.cs, Core/HistoricalCampaignSave.cs, Core/UrukCampaignSystem.cs, Core/UrukSubsistenceSystem.cs` — 固定史実マップ、可変年代、8勢力、小集落1,500人、役割・地位・物資・施設、5%刻み公共労働、備蓄月数・損失・種籾・容量、人口収支、原因付き地位変化、9要因社会安定、神殿5段階、数量記録行政、ウルク都市国家化、データセット版数、出典・確度・権利・生成素材の製品収録ゲート。Core純度と決定性は通常Simulationと同じ |
...
| Historical campaign UI | `UI/HistoricalCampaignPanel.cs` — 年代・推定人口幅・備蓄月数・農地・運河・神殿5段階・安定度、最大リスクと3行動の顧問、5%刻み労働配分、人口／食料／地位／社会内訳、簡潔／詳細、史実クイックセーブ、暫定ローポリ復元模型。sortingOrder 122の独立Canvas |
