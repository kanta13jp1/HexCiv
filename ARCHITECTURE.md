...
| Simulation | `Core/GameStateOps.cs, Core/Player.cs, Core/Unit.cs, Core/City.cs, Core/Combat.cs, Core/Pathfinder.cs, Core/Visibility.cs, Core/TurnManager.cs, Core/SaveLoad.cs, Core/CivilizationCatalog.cs, Core/LeaderCatalog.cs, Core/HeritageSiteCatalog.cs, Core/GreatPersonCatalog.cs, Core/ResearchMilestoneCatalog.cs, Core/CulturalTraditionCatalog.cs, Core/MasterpieceCatalog.cs, Core/GlobalHistoryIndex.cs, Core/TechnologyCatalog.cs, Core/CulturePolicyCatalog.cs, Core/CultureSystem.cs, Core/WorldLegacySystem.cs, Core/MasterpieceSystem.cs` (SaveLoad: 決定的なセーブ/ロード直列化。CivilizationCatalog: 92文明。LeaderCatalog: 指導者179件。HeritageSiteCatalog: 遺跡・史跡108件。GreatPersonCatalog: 偉人120人。ResearchMilestoneCatalog: 研究史120件。CulturalTraditionCatalog: 文化史120件。MasterpieceCatalog: 書籍・絵画・彫刻・建築・音楽・演劇・映画294件。GlobalHistoryIndex: 13分類・台帳1033件の横断集計と文明詳細地域の6地域写像。TechnologyCatalog: 既存12技術+研究史120件。CulturePolicyCatalog/CultureSystem: 文化史120件の政策化、文化ポイント、交流、文化勝利。WorldLegacySystem: 遺産12件の決定的配置・発見報酬、偉人ポイント・世界一意の登用・分野別効果・文明地域親和性。MasterpieceSystem: 作品ポイント、世界一意の収蔵、7分野効果、偉人連携。各CatalogはMonoBehaviour非依存の純データ台帳) |
