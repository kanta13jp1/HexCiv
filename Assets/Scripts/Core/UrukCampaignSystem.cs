...
namespace HexCiv.Core
{
    ...
    public sealed class UrukCampaignProgress
    {
        ...
        public UrukInformationDispatchState[] informationDispatches;
        ...
        public string selectedInformationFactionId;
        public string selectedInformationMedium;
    ...
    public static class UrukCampaignSystem
    {
            ...
            UrukCampaignProgress progress)
        {
            ...
            {
                UrukRegionalSystem.MigrateInformationV11(progress);
                progress.version = 11;
            }
            if (progress.version == 11)
            {
                UrukRegionalSystem.MigrateTransportForecastsV12(progress);
                progress.version = 12;
            }
            if (progress.version == 12)
            {
                UrukRegionalSystem.MigrateInformationPersonnelV13(progress);
                progress.version = 13;
            }
            if (progress.version == 13)
            {
                UrukRegionalSystem.MigrateInformationReceptionV14(definition, progress);
                progress.version = 14;
            }
            UrukSubsistenceSystem.EnsureDefaults(progress);
            UrukRegionalSystem.EnsureInitialized(definition, progress);
