...
namespace HexCiv.Core
{
    ...
    public static class LeaderCatalog
    {
        static readonly LeaderDef[] Definitions =
        {
            ...
            // ---- 第4弾: 新規12文明の代表指導者24件 ----
            // アフリカ
            Leader("dunama_dabbalemi", "kanem_bornu", "ドゥナマ・ダッバレミ", "マイ（君主）", "13世紀", "サイファワ朝の君主としてカネムの勢力を広げ、サハラ交易路とイスラーム制度を支えた。"),
            Leader("idris_alooma", "kanem_bornu", "イドリス・アローマ", "マイ（君主）", "16～17世紀", "軍制、司法、道路と交易の整備を進め、ボルヌの広域的な影響力を強めた。"),
            Leader("andrianampoinimerina", "merina", "アンドリアナンプイニメリナ", "メリナ王", "18～19世紀", "分裂していたイメリナを再統合し、アンブヒマンガとアンタナナリボを基盤に王国を拡大した。"),
            Leader("ranavalona_i", "merina", "ラナヴァルナ1世", "マダガスカル女王", "19世紀", "外圧が強まる時代に長期統治し、王国の主権と自立的な生産基盤の維持を図った。"),

            // 西・南アジア
            Leader("ardashir_i", "sasanian", "アルダシール1世", "諸王の王", "3世紀", "アルサケス朝を倒してサーサーン朝を創始し、イラン高原とメソポタミアの王権を再編した。"),
            Leader("khosrow_i", "sasanian", "ホスロー1世", "諸王の王", "6世紀", "税制と行政を改革し、学術と都市文化を保護した統治者として知られる。"),
            Leader("razia_sultan", "delhi_sultanate", "ラズィーヤ", "デリーのスルターン", "13世紀", "1236年に即位し、デリー・スルターン朝を自らの名で統治した女性君主。"),
            Leader("alauddin_khalji", "delhi_sultanate", "アラーウッディーン・ハルジー", "デリーのスルターン", "13～14世紀", "モンゴル軍への防衛、領域拡大、市場と軍制の改革を進めた。"),

            // 東・東南アジア
            Leader("queen_seondeok", "silla", "善徳女王", "新羅王", "7世紀", "新羅最初の女王として統治し、外交と仏教文化、天文観測施設の整備を支えた。"),
            Leader("king_muyeol", "silla", "武烈王", "新羅王", "7世紀", "唐との同盟を用いて百済を破り、朝鮮半島統合へ向かう政治過程を主導した。"),
            Leader("parameswara", "malacca", "パラメスワラ", "マラッカ創建者・君主", "14～15世紀", "マラッカ川河口に港市を築き、海峡交易を結ぶ王国の基礎を作った。"),
            Leader("mansur_shah_malacca", "malacca", "マンスール・シャー", "マラッカ・スルターン", "15世紀", "マラッカの交易網と外交圏が大きく広がった時期を統治した。"),

            // ヨーロッパ・地中海
            Leader("olga_of_kyiv", "kyivan_rus", "オリハ（オリガ）", "キーウ大公国摂政", "10世紀", "幼いスヴャトスラウの摂政として貢納制度を整え、コンスタンティノープルとの外交を行った。"),
            Leader("yaroslav_the_wise", "kyivan_rus", "ヤロスラウ賢公", "キーウ大公", "11世紀", "法典編纂、聖堂建設、王家間外交を通じてキーウ・ルーシの統治と文化を発展させた。"),
            Leader("joao_i_portugal", "portugal", "ジョアン1世", "ポルトガル国王", "14～15世紀", "アヴィス朝を開き、カスティーリャとの和平とイングランドとの同盟、セウタ遠征を進めた。"),
            Leader("manuel_i_portugal", "portugal", "マヌエル1世", "ポルトガル国王", "15～16世紀", "インド洋航路と海外交易が拡大した時期を統治し、航海事業とマヌエル様式の造営を保護した。"),

            // アメリカ大陸
            Leader("red_cloud", "lakota", "マフピーヤ・ルタ（レッド・クラウド）", "オグララ・ラコタ指導者", "19～20世紀", "ボーズマン街道沿いの砦建設に抵抗し、1868年のララミー砦条約交渉へつなげた。"),
            Leader("sitting_bull", "lakota", "タタンカ・イヨタケ（シッティング・ブル）", "フンクパパ・ラコタ指導者・聖人", "19世紀", "共同体の精神的・政治的指導者として、土地と生活様式を守る運動を率いた。"),
            Leader("wahunsenacawh", "powhatan", "ワフンセナコー（ポウハタン）", "ママナトウィック（最高位首長）", "16～17世紀", "ツェナコンマカの多数の共同体を連合し、ジェームズタウン建設初期の外交を担った。"),
            Leader("opechancanough", "powhatan", "オペチャンカノー", "パマンキーの首長・連合指導者", "16～17世紀", "ワフンセナコーの後継世代として連合を率い、植民地拡大への長期的な抵抗を指揮した。"),

            // オセアニア
            Leader("pomare_ii", "tahiti", "ポマレ2世", "タヒチ王", "18～19世紀", "1815年のフェイ・ピの戦い後にタヒチの統合を確立し、新たな法と宗教秩序を整えた。"),
            Leader("pomare_iv", "tahiti", "ポマレ4世", "タヒチ女王", "19世紀", "長期在位の女王として統治し、フランス保護領化と仏・タヒチ戦争の時代に王国を代表した。"),
            Leader("makea_pori", "rarotonga", "マケア・ポリ・アリキ", "マケア・ヌイのアリキ", "18～19世紀", "ラロトンガの高位首長として統治し、1820年代のキリスト教受容と社会変化に関わった。"),
            Leader("makea_takau", "rarotonga", "マケア・タカウ・アリキ", "マケア・ヌイのアリキ・連邦政府首長", "19～20世紀", "伝統首長として長期にわたり統治し、保護領化とクック諸島連邦形成期の政治を担った。"),
        };
