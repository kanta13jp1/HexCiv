    ...
    public sealed class UrukRegionalPanel : MonoBehaviour
    {
        ...
        public void Refresh()
        {
            ...
            string offerText = offer == null
                ? "交易提案なし"
                : $"{FactionName(progress, offer.proposerFactionId)}: " +
                  $"{GoodNameJa(offer.offeredGoodId)}{offer.offeredAmount} ↔ " +
        ...
        void BuildUi()
        {
            ...
            UIStyle.SetRect(body, new Vector2(0f, 0f), new Vector2(0f, 0f),
                new Vector2(0f, 0f), new Vector2(18f, 18f), new Vector2(720f, 274f));
            ...
            CreateButton(body.transform, "NextFarm", "農地を切替", 348f, 132f, 94f,
                NextFarm);
            ...
            CreateButton(body.transform, "CropBarley", "大麦", 12f, 88f, 70f,
                () => Apply(UrukRegionalSystem.CropBarleyAction));
            CreateButton(body.transform, "CropEmmer", "エンマー", 88f, 88f, 82f,
                () => Apply(UrukRegionalSystem.CropEmmerAction));
            CreateButton(body.transform, "CropFallow", "休耕", 176f, 88f, 70f,
            ...
            CreateButton(body.transform, "Gift", "食料贈与", 362f, 88f, 92f,
                () => Apply(UrukRegionalSystem.SendGiftAction));
            CreateButton(body.transform, "Barter", "物々交換", 460f, 88f, 92f,
